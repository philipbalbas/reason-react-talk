...
1,2 > Destructuring is also an application of pattern matching
4,5,6,7,8,9 > Pattern matching is much cleaner compared to if/else
11,12,13,14 > Reducer functions also utilizes pattern matching
14 > "text" is the payload
```
